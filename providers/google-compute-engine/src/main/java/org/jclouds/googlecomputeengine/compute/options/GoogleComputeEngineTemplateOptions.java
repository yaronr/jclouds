...
public final class GoogleComputeEngineTemplateOptions extends TemplateOptions {
	...
	public void copyTo(TemplateOptions to) {
		...
		if (to instanceof GoogleComputeEngineTemplateOptions) {
			GoogleComputeEngineTemplateOptions eTo = GoogleComputeEngineTemplateOptions.class
					.cast(to);
	 ...
	 */
	public GoogleComputeEngineTemplateOptions autoCreateKeyPair(
			boolean autoCreateKeyPair) {
	...
	/**
	 * Sets a list of service accounts, with their specified scopes, to
	 * authorize on created instance. For example, to give a node the 'compute'
	 * scope you would add a service account with the email 'default' and the
	 * scope 'https://www.googleapis.com/auth/compute' These scopes will be
	 * given to all nodes created with these template options.
	 */
	public GoogleComputeEngineTemplateOptions serviceAccounts(
	...
	/**
	 * Gets the list of service accounts, with their specified scopes, that will
	 * be authorize on created instances.
	 */
	...
	public GoogleComputeEngineTemplateOptions blockOnPort(int port, int seconds) {
		return GoogleComputeEngineTemplateOptions.class.cast(super.blockOnPort(
				port, seconds));
	}
	...
	public GoogleComputeEngineTemplateOptions inboundPorts(int... ports) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
				.inboundPorts(ports));
	}
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions authorizePublicKey(
			String publicKey) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions installPrivateKey(
			String privateKey) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions blockUntilRunning(
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions overrideLoginCredentials(
			LoginCredentials overridingCredentials) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
				.overrideLoginCredentials(overridingCredentials));
	}
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions overrideLoginPassword(
			String password) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions overrideLoginPrivateKey(
			String privateKey) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions overrideAuthenticateSudo(
			boolean authenticateSudo) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
				.overrideAuthenticateSudo(authenticateSudo));
	}
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions userMetadata(
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions nodeNames(
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions wrapInInitScript(
			boolean wrapInInitScript) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
				.wrapInInitScript(wrapInInitScript));
	}
	 ...
	 */
	@Override
	public GoogleComputeEngineTemplateOptions blockOnComplete(
			boolean blockOnComplete) {
		return GoogleComputeEngineTemplateOptions.class.cast(super
				.blockOnComplete(blockOnComplete));
	}
